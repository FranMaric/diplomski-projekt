...
"""
rostopic pub /drone0/planning/triger/array geometry_msgs/PoseArray "header:
  stamp: {secs: 0, nsecs: 0}
  frame_id: 'world'
poses:
- position: {x: -0.7982, y: 2.0, z: 3.67}
  orientation: {x: -0.6738529, y: -0.4492353, z: 0.0, w: 0.5866089}
- position: {x: -1.0, y: -3.0, z: 4.0}
